...
function Login() {
  ...
  // Utility function to get a cookie by name (e.g. "csrftoken")
  ...
  useEffect(() => {
    ...
    // Check if the user is already authenticated (for example, by checking sessionid or other token)
  ...
  const validateForm = () => {
    ...
    try {
      const url = "/api/login"; // Note the trailing slash
      ...
      // Read the response as text first; if empty, use an empty object.
      ...
      // Replace raw JSON parse errors with a friendlier message
